        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body p-4">
                    <form class="row g-3" action="{{ route('role.update',['role'=>$user->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        is-invalid
                    @enderror"
                                id="admin_name" placeholder="Enter admin name" value="{{ old('admin_name',$user->name) }}">
                            @error('admin_name')
                        ...
                        is-invalid
                    @enderror"
                                id="admin_email" placeholder="Enter admin email" value="{{ old('admin_email',$user->email) }}">
                            @error('admin_email')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong>
                                </span>
                            @enderror
                    ...
                    @enderror"
                        ...
                        <div class="col-4 mb-2">
                            <div class="form-check mb-2 mt-2">
                                ...
                                @if (old('category')) checked
                                @elseif ($user->category == 1)
                                checked @endif id="category">
                            ...
                            <div class="form-check mb-2 mt-2">
                                <input class="form-check-input" name="subcategory" type="checkbox" value="1"
                                    @if (old('subcategory')) checked
                                    @elseif ($user->subcategory == 1)
                                    checked @endif id="subcategory">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="1" name="division"
                                    @if (old('division')) checked
                                    @elseif ($user->division == 1)
                                    checked @endif id="division">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="1" name="district"
                                    @if (old('district')) checked
                                    @elseif ($user->district == 1)
                                    checked @endif id="district">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <div class="form-check mb-2 mt-2">
                                ...
                                @if (old('widget')) checked
                                @elseif ($user->widget == 1)
                                checked @endif id="widget">
                            ...
                            <div class="form-check mb-2">
                                ...
                                @if (old('permission')) checked
                                @elseif ($user->permission == 1)
                                checked @endif id="permission">
                        ...
                        <div class="col-4 mb-2">
                            <div class="form-check mb-2 mt-2">
                                ...
                                @if (old('gallery')) checked
                                @elseif ($user->gallery == 1)
                                checked @endif id="gallery">
                            ...
                            <div class="form-check mb-2 mt-2">
                                ...
                                @if (old('setting')) checked
                                @elseif ($user->setting == 1)
                                checked @endif id="setting">
