...
data-bg-src="{{ asset('assets/frontend') }}/img/bg/footer_bg_1.png">
                ...
                <div class="widget footer-widget">
                    <div class="th-widget-about">
                        <div class="about-logo"><a href="home-newspaper.html"><img
                                    src="{{ asset('assets/frontend') }}/img/logo-footer.svg"
                                    alt="Tnews"></a></div>
                        ...
                        <div class="th-social style-black"><a href="https://www.facebook.com/"><i
                        ...
                        <div class="recent-post">
                            ...
                            <div class="media-body">
                                <h4 class="post-title"><a class="hover-line"
                                        href="blog-details.html">Equality and justice for Every citizen</a>
                                </h4>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="widget widget_tag_cloud footer-widget">
                    ...
                    <div class="tagcloud"><a href="blog.html">Sports</a> <a href="blog.html">Politics</a>
                        <a href="blog.html">Business</a> <a href="blog.html">Music</a> <a
                            ...
                            href="blog.html">Weather</a> <a href="blog.html">Movies</a>
                    </div>
                </div>
            </div>
        </div>
